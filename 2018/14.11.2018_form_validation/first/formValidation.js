...
let par = document.querySelector('article.error');
...
let checkboxes = document.querySelectorAll('input[type="checkbox"]');
 ...
 fullName.addEventListener('invalid', function(ev) {
   ev.preventDefault();
   ...
   if (fullName.validity.valueMissing) {
     ...
     ev.currentTarget.setCustomValidity('Please enter at least 6 character!');
   }
